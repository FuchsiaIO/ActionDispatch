...
namespace ActionDispatch\Dispatcher\Test;
...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->factory = new \ActionDispatch\Dispatcher\Factory\RouterFactory;
    ...
    {
        $this->assertInstanceOf('\ActionDispatch\Dispatcher\Route\Route', $actual);
    }
    ...
    public function testAddAndGenerate()
    {
        ...
        // fail to match
        $this->setExpectedException('\ActionDispatch\Dispatcher\Exception\RouteNotFound');
    ...
    public function testGetAndSetRoutes()
    {
        ...
        $this->assertInstanceOf('\ActionDispatch\Dispatcher\Route\RouteCollection', $actual);
        $this->assertTrue(count($actual) == 2);
        $this->assertInstanceOf('\ActionDispatch\Dispatcher\Route\Route', $actual['page.browse']);
        $this->assertEquals('/page/', $actual['page.browse']->path);
        $this->assertInstanceOf('\ActionDispatch\Dispatcher\Route\Route', $actual['page.read']);
    ...
    public function testArrayAccess()
    {
        ...
        $this->setExpectedException('\ActionDispatch\Dispatcher\Exception\UnexpectedValue');
